...
class Struc2Vec():
    ...
    def train(self, embed_size=128, window_size=5, workers=3, iter=5):
        ...
        sentences = [[str(n) for n in walk] for walk in sentences] # my
        self.sentences = sentences # my
    ...
    def get_embeddings(self,):
        # Get embedding
        node_ids = self.w2v_model.wv.index_to_key  # list of node IDs
        node_embeddings = pd.DataFrame(self.w2v_model.wv.vectors, index=node_ids)
